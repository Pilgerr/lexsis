...
### Permissão para relatório "Sit. cta assinada"
- https://redmine.lexsis.com.br/issues/111217

### Item "10101010" com CFOP inválido. Verifique cadastro
- https://redmine.lexsis.com.br/issues/111330

### Suporte queóps não abre e nem permite instalação "c:\ pasta não está acessível"
- https://redmine.lexsis.com.br/issues/112067
...
### Erro SQL ao tentar gravar criação de novo usuário: "Violação da restrição PRIMARY KEY "PK_USUARIOS_BC41F7939761C8A0". Não""
- https://redmine.lexsis.com.br/issues/112263

### Problema na importação HSystem. Erro LexsisChannelManager: "Erro: ) HTTP/1.1 401 API Key is missing"
- https://redmine.lexsis.com.br/issues/112375

### Instalação e configuração TEF e erro SQL: "FALHA NO PAGAMENTO!!! Nome de objeto 'LEITURA ABASTECIMENTO' inválido."
- https://redmine.lexsis.com.br/issues/112549

### CONFIGURAÇÃO DE TAREFA PARA RECONEXÃO DO APACHE
- https://redmine.lexsis.com.br/issues/113840
...
### Imprimir item em comanda individual
- https://redmine.lexsis.com.br/issues/114552

### Configuração backup CCQ
- https://redmine.lexsis.com.br/issues/114653

### Retorno "cEnq": 9999" e bug campo "Outras desp.:" nas notas de saída.
- https://redmine.lexsis.com.br/issues/114825
  
### Erro SQL ao abrir APPS (CHAMADO RECORRENTE)
- https://redmine.lexsis.com.br/issues/114832
...
- https://redmine.lexsis.com.br/issues/114950

### Configuração saídas avulsas no Touch / Restaurente
- https://redmine.lexsis.com.br/issues/114953

### Remover opção de parcelamento da TEF crédito
- https://redmine.lexsis.com.br/issues/114956

### Mensagem ao auditar caixa: "Revise o cadastro de cartões..."
- https://redmine.lexsis.com.br/issues/114960

### Configuração nova estação com IP FIXO
- https://redmine.lexsis.com.br/issues/115043

### Notas em status 3 no emissor, mas aprovadas no SEFAZ
- https://redmine.lexsis.com.br/issues/115018
  
### Erro de CCQ ao abrir Cosmos
- https://redmine.lexsis.com.br/issues/115075

### Máquininha POS sem conexão VERIFICAR SE IP / MAC TA NA REDE
- https://redmine.lexsis.com.br/issues/115087

### I/O error 103 ao pagar mesa no Touch
- https://redmine.lexsis.com.br/issues/115099

### Duplicidade de NF-e
- https://redmine.lexsis.com.br/issues/115163

###  Erro ao abrir caixa. Processo inesperado no sistema: arithmetic exception, numeric overflow, or string truncation string right truncation
- https://redmine.lexsis.com.br/issues/115150

### Erro no pagamento com TEF LEITURA DE LOG DE ERRO NA TEF
- https://redmine.lexsis.com.br/issues/115245

### Pedido não integra IFood x Tele
- https://redmine.lexsis.com.br/issues/115337

### Parâmetro Controla mesa / bandeira não funciona
- https://redmine.lexsis.com.br/issues/115396
